!function(a) {
    ...
    t.prototype.init = function() {
        a("#basic-colorpicker").colorpicker(), a("#hex-colorpicker").colorpicker({ format: "auto" }),
            ...
            a("#reportrange span").html(moment().subtract(29, "days").format("MMMM D, YYYY") +
                " - " +
                moment().format("MMMM D, YYYY")), a("#reportrange").daterangepicker(
                {
                    format: "MM/DD/YYYY",
                ...
                function(t, e, o) {
                    console.log(t.toISOString(), e.toISOString(), o), a("#reportrange span")
                        .html(t.format("MMMM D, YYYY") + " - " + e.format("MMMM D, YYYY"))
                })
