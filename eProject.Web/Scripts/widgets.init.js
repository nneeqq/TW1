$(document).ready(function() {
        ...
        a = function() {
            $("#sparkline1").sparkline([0, 23, 43, 35, 44, 45, 56, 37, 40],
                ...
                $("#sparkline2").sparkline([3, 6, 7, 8, 6, 4, 7, 10, 12, 7, 4, 9, 12, 13, 11, 12],
                    { type: "bar", height: "165", barWidth: "10", barSpacing: "3", barColor: "#3bafda" }),
                $("#sparkline3").sparkline([20, 40, 30, 10],
                    ...
                    { type: "bar", height: "165", barWidth: "10", barSpacing: "3", barColor: "#00b19d" }), $(
                        "#sparkline6")
                    .sparkline([3, 6, 7, 8, 6, 4, 7, 10, 12, 7, 4, 9, 12, 13, 11, 12],
                        {
                            type: "line",
                            width: "100%",
                            height: "165",
    ...
    DrawMouseSpeed = function() {
        ...
        $("html").mousemove(function(i) {
            var e = i.pageX, a = i.pageY;
            -1 < r && (l += Math.max(Math.abs(e - r), Math.abs(a - o))), r = e, o = a
        });
        var h = function() {
            var i = (new Date).getTime();
            if (a && a != i) {
                var e = Math.round(l / (i - a) * 1e3);
                t.push(e), 30 < t.length && t.splice(0, 1), l = 0, $("#sparkline5").sparkline(t,
                    {
        ...
        setTimeout(h, 500)
    }, a(), DrawMouseSpeed(), $(window).resize(function(i) {
        clearTimeout(e), e = setTimeout(function() { a(), DrawMouseSpeed() }, 300)
    })
