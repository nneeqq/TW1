!function(a) {
    "use strict";
    var e = function() {};
    e.prototype.createBasic =
        function(e) { return new GMaps({ div: e, lat: -12.043333, lng: -77.028333 }) }, e.prototype.createMarkers =
        function(e) {
            ...
            return t.addMarker({
                ...
                click: function(e) { console.log && console.log(e), alert("You clicked in this marker") }
            }), t.addMarker({
                lat: -12.042,
                lng: -77.028333,
    ...
    }, e.prototype.createWithStreetview =
        function(e, t, l) { return GMaps.createPanorama({ el: e, lat: t, lng: l }) }, e.prototype.createWithRoutes =
        function(e, t, l) {
            ...
            return a("#start_travel").click(function(e) {
                e.preventDefault(), r.travelRoute({
                    ...
                    travelMode: "driving",
                    step: function(e) {
                        a("#instructions").append("<li>" + e.instructions + "</li>"),
                            a("#instructions li:eq(" + e.step_number + ")").delay(450 * e.step_number).fadeIn(200,
                                function() {
                ...
                options: [
                    {
                        ...
                        name: "add_marker",
                        action: function(e) {
                            this.addMarker({ lat: e.latLng.lat(), lng: e.latLng.lng(), title: "New marker" }), this
                                .hideContextMenu()
                        }
                    },
                    {
    ...
    }, e.prototype.createWithStyle =
        function(e, t) { new GMaps({ div: e, lat: -12.043333, lng: -77.028333, styles: t }) }, e.prototype.init =
        function() {
            var e = this;
            a(document).ready(function() {
                ...
                e.createWithPolygon("#gmaps-polygons",
                        ...
                        ]), e.createWithOverlay("#gmaps-overlay"), e.createWithStreetview("#panorama",
                        42.3455,
                        -71.0983),
                    e.createWithRoutes("#gmaps-route", -12.043333, -77.028333),
                    e.createMapByType("#gmaps-types", -12.043333, -77.028333),
                    e.createWithMenu("#gmaps-menu", -12.043333, -77.028333), e.createWithStyle("#ultra-light",
                        [
                            {
                                featureType: "water",
