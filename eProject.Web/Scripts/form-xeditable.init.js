$(function() {
    $.fn.editableform.buttons =
        ...
        $("#inline-username").editable({
            ...
            validate: function(e) { if ("" == $.trim(e)) return"This field is required" },
            mode: "inline",
            inputclass: "form-control-sm"
        }), $("#inline-sex").editable({
            ...
            display: function(t, e) {
                ...
                n.length
                    ? $(this).text(n[0].text).css("color", { "": "gray", 1: "green", 2: "blue" }[t])
                    : $(this).empty()
            }
        ...
        $("#inline-dob").editable({ mode: "inline", inputclass: "form-control-sm" }), $("#inline-event").editable({
            placement: "right",
            mode: "inline",
        ...
        $("#inline-fruits").editable({
            ...
            inputclass: "form-control-sm",
            source: [
                { value: 1, text: "Banana" }, { value: 2, text: "Peach" }, { value: 3, text: "Apple" },
