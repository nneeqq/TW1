$(window).on("load",
    function() {
        $("#demo-foo-row-toggler").footable(), $("#demo-foo-accordion").footable().on("footable_row_expanded",
            function(o) {
        ...
        t.footable().on("footable_filtering",
            function(o) {
            ...
            function(o) { o.preventDefault(), t.trigger("footable_filter", { filter: $(this).val() }) });
        ...
        e.footable().on("click",
                ...
                function(o) { o.preventDefault(), e.trigger("footable_filter", { filter: $(this).val() }) }),
